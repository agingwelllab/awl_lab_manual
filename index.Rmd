...
This manual was inspired by other lab manuals, including [MemoLab Manual](https://github.com/memobc/memolab-manual), [Peele Lab Manual](http://jpeelle.net/peellelab_manual.pdf), and [Smith Lab Manual](https://github.com/DVSneuro/smithlab_manual/blob/master/SmithLab_manual.pdf).
