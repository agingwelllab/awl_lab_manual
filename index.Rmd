...
Since we are a relatively new lab, this manual was inspired by (and in some places directly copied from) other lab manuals, including [MemoLab Manual](https://github.com/memobc/memolab-manual), [Peele Lab Manual](http://jpeelle.net/peellelab_manual.pdf), and [Smith Lab Manual](https://github.com/DVSneuro/smithlab_manual/blob/master/SmithLab_manual.pdf). Thanks to everyone who has shared their resources!

This lab manual was created in R Studio using the [bookdown](https://bookdown.org/yihui/bookdown/) package. 

![](images/awl.png){width=50%}
