...
Please understand that as a faculty member, I have **numerous** jobs that you may or may not see me perform. These include ***teaching***, ***research***, and ***service***.
...
Because I am juggling all these tasks, I am going to ask **you** to do some things to help keep things organized. These details are included in the *"Managing Up"* section of the Communication chapter. 
...
<center>
![](images/patrick_writing_paper.jpg){width=75%}
</center>
...
(2) Return your CVL access card/Lab keys to appropriate CVL administrative staff.
(3) Get organized! Clean up your folders on the lab Box account and any physical computers. This means:
