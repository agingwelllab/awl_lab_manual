...
Please understand that as a faculty member, the I have numerous jobs that you may or may not see me perform. These include *teaching* classes and managing teaching assistant/s, *service* like reviewing grant proposals, journal manuscripts, dissertation proposals, dissertations, project proposals, various projects, Master's and Honor's theses, program applications, etc, and *research* like writing grant proposals, progress reports, and manuscripts. Because I am juggling all these tasks, I am going to ask you to do some things to help keep things organized. These details are included in the *"Managing Up"* section of the Communication chapter. 
...
* maintain regularly scheduled hours on weekdays (e.g. 9am-5pm, except for [UTD holidays](https://www.utdallas.edu/hr/news/holidays/)), 
...
(1) Schedule an exit interview with your mentor to wrap up your time in the lab. 
(2) Return your CVL access card/Lab keys to Vivian Brockwell.
(3) Clean up your folders on the lab Box account and any physical computers. This means:
* Deleting any personal files.
* Making sure that everything you were working on is clearly documented. This means creating a README file for any project folders. Make sure all files have descriptive names. 

You may be wondering what you can take with you when you leave. You are welcome to take copies of any posters, manuscripts, or scripts that you created during your time in the lab. However, **do not remove any AWL data from AWL/CVL/UTD storage devices.** During your exit interview, we can make arrangements to share the appropriate data with you if it is not already publicly available.  